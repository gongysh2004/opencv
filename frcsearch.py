...
imgBit = cv2.bitwise_and(imgGray,imgGray, mask= mask)
imgContour=img.copy()
img2=img.copy()
getContour(imgBit)
...
for meth in methods:
    ...
    cv2.putText(img2, meth, bottom_right,cv2.FONT_HERSHEY_COMPLEX, 0.6, (0,0,255),2)
    cv2.rectangle(img2,top_left, bottom_right, 255, 2)

stackImg = stackImages(0.6, ([img, imgBit,imgContour,template,img2]))
